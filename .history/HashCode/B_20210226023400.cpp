...
public:
    ...
    void app(unordered_map<int, unordered_map<string, int>>& intersections)
    {
        printIntersections(intersections);
    }


    void solve( vector<car_t>& cars, vector<street_t>& streets, unordered_map<int, unordered_map<string, int>>& intersections)
    {
    }

private:

    void printIntersections(unordered_map<int, unordered_map<string, int>>& intersections)
    {
