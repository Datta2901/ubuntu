...
void isaValidCell(int i,int j,vector<vector<int>> &grid,string p,vector<int> &Path,vector<vector<int>> &cost,int Cost,vector<int> &temp,vector<pair<string,int>> &vect){
