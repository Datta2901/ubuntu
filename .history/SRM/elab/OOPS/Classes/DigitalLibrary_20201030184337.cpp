...
class library
{
    ...
    void count()
    {c++;}};int main(){int rol,boco,rol2,boco2;string name1, name2;cin>>rol>>name1>>boco>>rol2>>name2>>boco2;library lib1(rol,name1,boco);lib1.show();library lib2(rol2,name2,boco2);lib2.show();return 0;}