...
SomeStandardNumbers00 = {100:'One hundred and',200:'Two hundred and', 300:'Three hundred and',400: 'Four hundred and', 500:'Five hundred and',600: 'Six hundred and', 700:'Seven hundred and', 800:'Eight hundred and', 900:'Nine hundred and'}
...
if(num0017<=19):
    ...
    div=num0017/100
    div=int(div)
    print(" ",SomeStandardNumbers00[div])
    intz=num0017%100
    if(intz<=19):
        print(" ",0033[intz])
