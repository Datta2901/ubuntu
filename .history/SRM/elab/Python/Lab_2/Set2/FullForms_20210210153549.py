numbersLessThan11 00= {0:'zero',1: 'One', 2: 'Two', 3: 'Three', 4: 'Four', 5: 'Five', \
...
if(num0017<=19):
    print(numbersLessThan1100[num0017],end = " ")
elif(num0017>=20)and(num0017<100):
    div=int(num0017/10)
    print(" ",someFIxedNumbers[div])
    div2=num0017%10
    print(" ",numbersLessThan1100[div2])
    ...
    intz=num0017%100
    if(intz<=19):
        print(" ",numbersLessThan1100[intz])
