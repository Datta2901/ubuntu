...
number0=int(input("Enter a number less than 1000:"))
if(number0<=19):
    print(numbersLessThan110033[number0],end = " ")
elif(number0>=20)and(number0<100):
    div=int(number0/10)
    print(" ",someFIxedNumbers[div])
    div2=number0%10
    print(" ",numbersLessThan110033[div2])
elif(number0>=100)and(number0<1000):
    div=number0/100
    div=int(div)
