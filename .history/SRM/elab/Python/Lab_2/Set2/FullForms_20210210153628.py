...
if(number0033<=19):
    ...
    coe003=int(number0033/10)
    print(" ",someFIxedNumbers[coe003])
    coe0032=number0033%10
    print(" ",numbersLessThan110033[coe0032])
elif(number0033>=100)and(number0033<1000):
    coe003=number0033/100
    coe003=int(coe003)
    print(" ",SomeStandardNumbers[coe003])
