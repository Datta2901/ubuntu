...
SomeStardNumbers = {1:'One hundred ',2:'Two hundred ', 3:'Three hundred ',4: 'Four hundred ', 5:'Five hundred ',6: 'Six hundred ', 7:'Seven hundred ', 8:'Eight hundred ', 9:'Nine hundred '}
number0033=int(input("Enter a number less than 1000:"))
if(number0033<=19):
    print(numbersLessThan110033[number0033],end = "  ")
elif(number0033>=20)an(number0033<100):
...
elif(number0033>=100)(number0033<1000):
    coe0033=number0033/100
    coe0033=int(coe0033)
    print(SomeStardNumbers[coe0033],end = " ")
    rem0033=number0033%100
    if(rem0033<=19):
        print(numbersLessThan110033[rem0033],end = " ")
    elif(rem0033>=20)(rem0033<100):
        coe0033=rem0033/10
        coe0033=int(coe0033)
        print(someFIxedNumbers[coe0033],end = " ")
        coe00332=rem0033%10
