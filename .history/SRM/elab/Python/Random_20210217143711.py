...
def calc():
    ...
    if(y003<100):
        ...
        print("bill =", y003 ," rupees\n")
    if x0033>199 and x0033<400:
        y003=200*1.2 + (x0033-200)*1.5
    if(y003>400):
        print("bill = ", y003+0.15*y003, " rupees\n")
    else:
        print("bill = ", y003, " rupees\n")
    if x0033>=400 and x0033<600 :
        y003=199*1.2 + 200*1.5 + (x0033-399)*1.8
        print("bill =", y003+0.15*y003, " rupees \n")
    if x0033>250 :
        y003=199*1.2 + 200*1.5 + 200*1.8 + (x0033-599)*2
    print("bill = ", y003+0.15*y003, " rupees \n")
i=0
for i in range(5):
    print("\nBill for user ", i ,"\n")
