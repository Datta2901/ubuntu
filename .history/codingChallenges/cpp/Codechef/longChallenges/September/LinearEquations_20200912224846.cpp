    ...
    testcase(){
        ...
        int count;
            ...
            for(auto it = athe.begin(); it != athe.end(); it++){
                for(auto ip = it->second.begin(); ip != (it->second).end(); it++){
                    for(auto itr = athe[*ip].begin(); itr != athe[*ip].begin(); itr++){
            ...
            for(auto it = athe.begin(); it != number.end(); it++){
                infected.pb((it->second).size());
            }
