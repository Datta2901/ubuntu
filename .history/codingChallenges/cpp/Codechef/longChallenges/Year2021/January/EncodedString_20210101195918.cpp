...
vector<char> alphabets{'0','a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p'};
vector<char> alphabets{'0','a','b','c','d','e','f','g','h','i','j','k','l','m','n','o',''};


void BinarySearch(string pattern,int control){
    int start  = 1,end = 16,mid = (start + end)/2;
