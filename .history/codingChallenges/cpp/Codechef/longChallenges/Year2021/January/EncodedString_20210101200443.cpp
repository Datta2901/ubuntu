...
vector<int> a{1,2,3};
void BinarySearch(string pattern,int control,vector<const char> alphabets){
    ...
    for(int j = 0; j < control ; j++){
        ...
        cout << alphabets[mid] << a[1];
    }   
}

int main(){
    EXECUTE_FASTER
    vector<const char> alphabets{'0','a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p' };
    testcase(){
        int size;
        string pattern;
        cin  >> size >> pattern;
