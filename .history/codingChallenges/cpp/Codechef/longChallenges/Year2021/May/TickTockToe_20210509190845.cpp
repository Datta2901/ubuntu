...
int main(){
    ...
    while(t--){
        ...
        if(flag1 && flag2 || (countx - counto) < 0 || (countx - counto) > 1){
            cout << 3 << endl;
            continue;
        }
        // position is reachable and  game end  win 
        else if((flag1 && flag2 == false) && countx - counto > 0){
            cout << 1 << endl;
        }

        else if(flag1 == false && flag2 && countx - counto == 0){
            cout << 1 << endl;
        }
        // position is reachable and game end 
        else if(flag1 == flag2 && flag1 == false && count_1 == 0){
            cout << 1 << endl;
        }else if(flag1 == flag2 && flag1 == false && count_1 > 0){
            cout << 2 << endl;
        }else{
