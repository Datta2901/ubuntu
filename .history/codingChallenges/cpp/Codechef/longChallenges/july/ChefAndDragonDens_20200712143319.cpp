...
long int sum(vector<pair<long int,long int> > heights,vector<long int> taste, long int a,long int b){
    long int sum = 0;
    for(vector<pair<long int,long int> > :: iterator it = heights.begin() + min(a,b); it != heights.end();
