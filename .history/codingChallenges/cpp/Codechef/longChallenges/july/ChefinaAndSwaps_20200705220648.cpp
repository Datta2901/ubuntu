...
int main(){
    testcase(){
        ...
        //              answer += (A[i].second - B[j].second) * min(A[i].first,B[j].first);
        //              A[i].second -=  B[j].second;
        //              j++;
        //           }else if(A[i].second == B[j].second){
        //               answer += (A[i].second) * min(A[i].first,B[j].first);
        //               i++;
        //               j++; 
        ...
        //     break;
        //   }
        vector<long int,long int> required(A.begin(),A.end());
        printVectofPairs(required)
          cout << answer << endl;
