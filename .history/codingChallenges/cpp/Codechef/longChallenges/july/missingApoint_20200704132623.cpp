...
int main(){
    ...
    testcase(){
        ...
        loop(4 * size - 1){
            ...
            xcoordinate = (firstAxis.count(xcoordinate) > 0)  ? firstAxis.erase(xcoordinate) : xcoordinate;firstAxis.insert(xcoordinate);
            ycoordinate = (secondAxis.count(ycoordinate) > 0) ? secondAxis.erase(ycoordinate) :y secondAxis.insert(ycoordinate);
