...
int main(){
    ...
    testcase(){
        ...
        loop(4 * size - 1){
            ...
            if((firstAxis.count(xcoordinate) == 0)){
                firstAxis.insert(xcoordinate);      // if element is not there in set then add the element
                ...
                secondAxis.erase(ycoordinate);      // if the element is already there then remove it 
            }else if((secondAxis.count(ycoordinate) == 0)){
                secondAxis.insert(ycoordinate);     // if the element is not there in set add the element
            }       
        }
