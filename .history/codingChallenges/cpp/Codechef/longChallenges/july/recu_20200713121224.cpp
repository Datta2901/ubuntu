...
ll FindFromEnd(v<ll>taste,v<ll> heights,ll start,ll end){
    ll maximum = 0 ;
    if(start == end){
        return taste[end];
    }
    ...
    ll a = FindFromEnd(taste,heights,start - 1,end - 2);
    ll b = taste[start] + FindFromEnd(taste,heights,start,end - 1);
    if(a == -1 && b == -1){
        return -1;
    }
    if(a == -1){
...
ll Findfromstart(v<ll>taste,v<ll> heights,ll start,ll end){
    ll maximum = 0 ;
    if(start == end){
        return taste[end];
    }
    ...
    ll a = Findfromstart(taste,heights,start + 2,end);
    ll b = taste[start] + Findfromstart(taste,heights,start + 1,end);
    if(a == -1 && b == -1){
        return -1;
    }
    if(a == -1){
...
int main(){
    ...
    while(Queries--){
        ...
        if(a == 1){
            ...
            if(b - 1 < c - 1){
                answer =  Findfromstart(taste,height,b - 1,c - 1);
                cout << answer << endl;
            }
            if(c -1 < b -1){
                answer = FindFromEnd(taste,height,c - 1,b - 1);
                cout << answer << endl;
            }
