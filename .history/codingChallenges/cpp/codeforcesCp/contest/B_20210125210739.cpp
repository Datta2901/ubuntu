...
void solve(){
    ...
    int res1,res2;
    if(floor(a / 2020) == ceil(a /200)){
        res1 = a/2020;
    }else{
        res1 = (a / 2020) - 1;
    }
    if(floor(a / 2021) == ceil(a /2021)){
        res1 = a/2021;
    }else{
        res1 = (a / 202) - 1
    }
    int re1 = floor(a / 2020);
    int re2 = floor(a / 2021);
    if((a - re1 * 2020) % 2021 == 0){
        cout << "YES" << endl;
        return ;
    }
    if((a -re1 * 2021) % 2020 == 0){
        cout << "YES" << endl;
        return ;
    }
    if(re1 * 2020 + re2 * 2021 == a){
        cout << "YES" << endl;
        return ;
    }
    cout << "NO" << endl;
