...
void solve(){
    ...
    int res1,res2;
    if(floor(float(a) / 2020) == ceil(float(a) /2020)){
        res1 = a / 2020;
    }else{
        int result = a;
        res1  = 0;
        while(result != 0){
            if(result % 2020 == 0) res1++;
            result /= 2020;
        }
    }
    if(floor(float(a) / 2021) == ceil(float(a) /2021)){
        res2 = a/2021;
    }else{
        int result = a;
        res2  = 0;
        while(result != 0){
            if(result % 2020 == 0)res2++;
            result /= 2021;
        }
    }
    if((a - res1 * 2020) % 2021 == 0){
        cout << "YES" << endl;
        return ;
    }
    if((a -res2 * 2021) % 2020 == 0){
        cout << "YES" << endl;
        return ;
    }
    if(res1 * 2020 + res2 * 2021 == a){
        cout << "YES" << endl;
        return ;
    }
    cout << "NO" << endl;
