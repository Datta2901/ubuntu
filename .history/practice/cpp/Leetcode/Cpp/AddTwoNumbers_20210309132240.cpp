...
int main(){
    int size1,size2;
    cin >> size1 >> size2;
    struct ListNode *head1 = NULL,*head2 = NULL,*temp1,*temp;//temp is used to store the address of the present node//head is used to store the address of the first node
